...
public class Observability implements ChatModelListener {
    ...
    public void onResponse(ChatModelResponseContext responseContext) {
        ...
        if (tokenUsage instanceof OpenAiTokenUsage openAiTokenUsage) {
            ...
            System.out.println(Optional.ofNullable(openAiTokenUsage.outputTokensDetails()).map(OpenAiTokenUsage.OutputTokensDetails::reasoningTokens));
        }
